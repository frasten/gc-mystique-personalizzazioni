...
function grandicarnivori_init() {
	...
	$config['logo'] = GRANDICARNIVORI_PLUGIN_URL . '/img/logonew.png';
...
function mystique_custom_nav_icons($nav_extra)
{
	...
	$nav_extra .= '<a href="http://www.youtube.com/grandicarnivori" class="nav-extra youtube" title="Canale YouTube"><span>Canale YouTube</span></a>';
